...
- **2026-05-27: Add app-specific View menu commands.** Added standard View-menu commands for dashboard navigation, transcript search focus, details visibility, inspector panel switching, and graph zoom/reset using focused scene-local command handlers.
